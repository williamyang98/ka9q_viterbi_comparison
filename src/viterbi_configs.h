...
static Decoder_Config<int8_t, uint8_t> get_soft8_decoding_config(const size_t code_rate) { 
...
static Decoder_Config<int8_t, uint8_t> get_hard8_decoding_config(const size_t code_rate) {
